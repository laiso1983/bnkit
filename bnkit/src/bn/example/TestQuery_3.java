...
//            System.out.println("Variable elimination--------------");
            ...
            for (Variable query : qVars) {
                ...
                try {
                    ...
                    double prob1 = d.get("7");
                    double prob2 = d.get("6");
                    double prob3 = d.get("5");
                    double prob4 = d.get("4");
                    double prob5 = d.get("3");
                    double prob6 = d.get("2");
                    double prob = prob1+prob2+prob3+prob4+prob5+prob6;
                    List<Object> newList = new ArrayList<>();
                    newList.add(mKey);
                    newList.add(prob);
